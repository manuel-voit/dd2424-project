...
DEFAULT_TARGET_MODE = "targeted"  # "targeted" (3x3 convs) or "general" (all convs)
DEFAULT_NUM_LAST_STAGES = 2       # 1 -> layer4, 2 -> layer3+layer4, etc.
...
def main():
    ...
    generated_count = 0
    for model in MODELS:
        targets = get_lora_targets(model, DEFAULT_TARGET_MODE, DEFAULT_NUM_LAST_STAGES)
        for rank in RANKS:
            ...
            run_name = (
                ...
                f"nl{DEFAULT_NUM_LAST_STAGES}_r{rank}"
            )
